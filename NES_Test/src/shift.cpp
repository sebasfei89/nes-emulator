...
SCENARIO("Arithmetic shift left") {
    ...
    // X-Indexed Zero Page
    nes.testProgram("ASL $00,X with [$0001]=0x80 and X=1", {OP::ASL_XZP, 0x00 }, 6, {{OPAddr::X, 1}, {OPAddr::MemZeroPage_1, 0x80}}, 0x80, OPAddr::MemZeroPage_1, 0x00, 0x03);
    nes.testProgram("ASL $FF,X with [$0000]=0x41 and X=1", {OP::ASL_XZP, 0xFF }, 6, {{OPAddr::X, 1}, {OPAddr::MemZeroPage, 0x41}}, 0x03, OPAddr::MemZeroPage, 0x82, 0x80);
}
...
SCENARIO("Logical shift right") {
    ...
    // X-Indexed Zero Page
    nes.testProgram("LSR $00,X with [$0001]=0x01 and X=1", {OP::LSR_XZP, 0x00}, 6, {{OPAddr::X, 1}, {OPAddr::MemZeroPage_1, 0x01}}, 0x80, OPAddr::MemZeroPage_1, 0x00, 0x03);
    nes.testProgram("LSR $FF,X with [$0000]=0x80 and X=1", {OP::LSR_XZP, 0xFF}, 6, {{OPAddr::X, 1}, {OPAddr::MemZeroPage, 0x80}}, 0x83, OPAddr::MemZeroPage, 0x40, 0x00);
}
...
SCENARIO("Rotate left") {
    ...
    // X-Indexed Zero Page
    nes.testProgram("ROL $00,X with [$0001]=0x80 and X=1 and C=0", {OP::ROL_XZP, 0x00}, 6, {{OPAddr::MemZeroPage_1, 0x80}, {OPAddr::X, 1}}, 0x80, OPAddr::MemZeroPage_1, 0x00, 0x03);
    nes.testProgram("ROL $FF,X with [$0000]=0x40 and X=1 and C=1", {OP::ROL_XZP, 0xFF}, 6, {{OPAddr::MemZeroPage, 0x40}, {OPAddr::X, 1}}, 0x03, OPAddr::MemZeroPage, 0x81, 0x80);
}
...
SCENARIO("Rotate right") {
    ...
    // X-Indexed Zero Page
    nes.testProgram("ROR $00,X with [$0001]=1 and X=1 and C=0", {OP::ROR_XZP, 0x00}, 6, {{OPAddr::MemZeroPage_1, 1}, {OPAddr::X, 1}}, 0x80, OPAddr::MemZeroPage_1, 0x00, 0x03);
    nes.testProgram("ROR $FF,X with [$0000]=2 and X=1 and C=1", {OP::ROR_XZP, 0xFF}, 6, {{OPAddr::MemZeroPage, 2}, {OPAddr::X, 1}}, 0x03, OPAddr::MemZeroPage, 0x81, 0x80);
}
