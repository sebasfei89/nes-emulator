...
SCENARIO("Stack instructions")
{
    ...
    nes.testProgram("PHP", {OP::PHP_IMP}, 3, {}, 0xDF, {{OPAddr::MemSTK_0, 0xDF}, {OPAddr::SP, 0xFE}}, 0xDF);
    ...
    nes.testProgram("PLP with STK = [$DF]", {OP::PLP_IMP}, 4, {{OPAddr::SP, 0xFE}, {OPAddr::MemSTK_0, 0xDF}}, 0x00, OPAddr::SP, 0xFF, 0xDF);
}
