...
SCENARIO("Control flow instructions")
{
    ...
    nes.testProgram("BRK", { OP::BRK_IMP }, 7,
        ...
        {{OPAddr::MemSTK_0, 0x80}, {OPAddr::MemSTK_1, 0x02}, {OPAddr::MemSTK_2, 0x71}, {OPAddr::SP, 0xFC}, {OPAddr::PC_HI, 0x40}, {OPAddr::PC_LO, 0x20}}, 0x45); // Expected state

    nes.testProgram("RTI", { OP::RTI_IMP }, 6,
        {{OPAddr::MemSTK_0, 0x40}, {OPAddr::MemSTK_1, 0x20}, {OPAddr::MemSTK_2, 0xCF}, {OPAddr::SP, 0xFC}}, 0x30, // Initial state
        {{OPAddr::PC_HI, 0x40}, {OPAddr::PC_LO, 0x20}, {OPAddr::SP, 0xFF} }, 0xFF); // Expected state

    nes.testProgram("RTS", { OP::RTS_IMP }, 6,
        {{OPAddr::MemSTK_0, 0x40}, {OPAddr::MemSTK_1, 0x20}, {OPAddr::SP, 0xFD}}, 0x00, // Initial state
