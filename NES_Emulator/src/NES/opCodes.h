...
static constexpr uint8_t
    ...
    /*1x*/               ORA_ZIY=0x11,                             ORA_XZP=0x15, ASL_XZP=0x16, CLC_IMP=0x18, ORA_YAB=0x19,                             ORA_XAB=0x1D, ASL_XAB=0x1E,
    ...
    /*3x*/               AND_ZIY=0x31,                             AND_XZP=0x35, ROL_XZP=0x36, SEC_IMP=0x38, AND_YAB=0x39,                             AND_XAB=0x3D, ROL_XAB=0x3E,
    ...
    /*5x*/               EOR_ZIY=0x51,                             EOR_XZP=0x55, LSR_XZP=0x56, CLI_IMP=0x58, EOR_YAB=0x59,                             EOR_XAB=0x5D, LSR_XAB=0x5E,
    ...
    /*7x*/               ADC_ZIY=0x71,                             ADC_XZP=0x75, ROR_XZP=0x76, SEI_IMP=0x78, ADC_YAB=0x79,                             ADC_XAB=0x7D, ROR_XAB=0x7E,
    /*8x*/               STA_XZI=0x81,               STY_ZPG=0x84, STA_ZPG=0x85, STX_ZPG=0x86, DEY_IMP=0x88,               TXA_IMP=0x8A, STY_ABS=0x8C, STA_ABS=0x8D, STX_ABS=0x8E,
    /*9x*/               STA_ZIY=0x91,               STY_XZP=0x94, STA_XZP=0x95, STX_YZP=0x96, TYA_IMP=0x98, STA_YAB=0x99, TXS_IMP=0x9A,               STA_XAB=0x9D,
    ...
    /*Bx*/               LDA_ZIY=0xB1,               LDY_XZP=0xB4, LDA_XZP=0xB5, LDX_YZP=0xB6, CLV_IMP=0xB8, LDA_YAB=0xB9, TSX_IMP=0xBA, LDY_XAB=0xBC, LDA_XAB=0xBD, LDX_YAB=0xBE,
    ...
    /*Dx*/               CMP_ZIY=0xD1,                             CMP_XZP=0xD5, DEC_XZP=0xD6, CLD_IMP=0xD8, CMP_YAB=0xD9,                             CMP_XAB=0xDD, DEC_XAB=0xDE,
    ...
    /*Fx*/               SBC_ZIY=0xF1,                             SBC_XZP=0xF5, INC_XZP=0xF6, SED_IMP=0xF8, SBC_YAB=0xF9,                             SBC_XAB=0xFD, INC_XAB=0xFE;
}
